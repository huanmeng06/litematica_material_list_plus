...
public final class PlacementOriginMarker {
    ...
    public static void render(net.minecraft.class_4184 camera) {
        ...
        try {
            ...
            if (target.sameDimension && client.field_1724 != null) {
                drawTargetInfo(matrices, camera, client, current, target.pos);
            }
        } finally {
            endOverlayState();
        }
    ...
    private static void drawBeam(class_4587 matrices, class_2338 pos, class_243 cameraPos) {
        ...
        class_4597.class_4598 consumers = class_4597.method_22991(LABEL_TEXT_ALLOCATOR);
    ...
    private static void beamVertex(class_4587 matrices, class_4588 buffer, int color,
        ...
        buffer.method_56824(matrices.method_23760(), x, y, z)
                .method_39415(color)
                .method_22913(u, v)
    ...
    private static void drawTargetTexture(Matrix4f matrix, float alpha) {
        ...
        class_286.method_43433(buffer.method_60794());
        RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
    }
