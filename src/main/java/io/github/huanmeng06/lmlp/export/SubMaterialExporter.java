...
public final class SubMaterialExporter {
    ...
    private static String stylesXml() {
        return "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "<font><sz val=\"11\"/><color theme=\"1\"/><name val=\"NSimSun\"/><family val=\"3\"/><charset val=\"134\"/></font>"
                + "<font><b/><sz val=\"11\"/><color theme=\"1\"/><name val=\"NSimSun\"/><family val=\"3\"/><charset val=\"134\"/></font>"
                + "</fonts>"
                + "<fills count=\"4\">"
