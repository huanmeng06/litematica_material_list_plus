...
> **当前最新正式版**：[v1.9.3](https://github.com/huanmeng06/litematica_material_list_plus/releases/tag/v1.9.3)
...
| --- | --- | --- | --- | --- |
| 1.20.1 | `mc1.20.1` | 17 | v1.9.3 | ✅ |
| 1.20.4 | `mc1.20.4` | 17 | v1.9.3 | ✅ |
| 1.20.6 | `mc1.20.6` | 21 | v1.9.3 | ✅ |
| 1.21.1 | `mc1.21.1` | 21 | v1.9.3 | ✅ |
| 1.21.4 | `mc1.21.1` | 21 | v1.7.0 | ⚠️ |
| 1.21.5 | `mc1.21.1` | 21 | v1.7.0 | ⚠️ |
| 1.21.10 | `mc1.21.10` | 21 | v1.9.3 | ✅ |
| 1.21.11 | `mc1.21.11` | 21 | v1.9.3 | ✅ |
