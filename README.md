...
| --- | --- | --- |
| `1.21.5` | `1.5.0+mc1.21.5` | `21` |
| `1.21.4` | `1.5.0+mc1.21.4` | `21` |
| `1.21.1` | `1.5.0+mc1.21.1` | `21` |
| `1.20.6` | `1.5.0+mc1.20.6` | `21` |
| `1.20.4` | `1.5.0+mc1.20.4` | `17` |
| `1.20.1` | `1.5.0+mc1.20.1` | `17` |

</div>

REI 是必要前置。没有 REI 时，配方摘要、配方详情页和递归拆分相关功能不可用。
...
| Minecraft | Fabric API | Litematica | MaLiLib | REI |
| --- | --- | --- | --- | --- |
| `1.21.5` | `≥0.128.2+1.21.5` | `≥0.22.4` | `≥0.24.3` | `≥19.0.809` |
| `1.21.4` | `≥0.119.4+1.21.4` | `≥0.21.6` | `≥0.23.5` | `≥18.0.808` |
| `1.21.1` | `≥0.116.12+1.21.1` | `≥0.19.60` | `≥0.21.10` | `≥16.0.799` |
| `1.20.6` | `≥0.100.8+1.20.6` | `≥0.18.3` | `≥0.19.2` | `≥15.0.787` |
| `1.20.4` | `≥0.97.3+1.20.4` | `≥0.17.4` | `≥0.18.4-alpha.1` | `≥14.1.786` |
| `1.20.1` | `≥0.92.9+1.20.1` | `≥0.15.4` | `≥0.16.3` | `≥12.1.785` |

</details>

**如果出现启动失败、材料列表异常或 REI 配方显示异常，请优先回退到表中的前置版本组合；若问题仍然存在，请提交 [Issue](https://github.com/huanmeng06/litematica_material_list_plus/issues/new)，并附上 Minecraft 版本、LMLP 版本、前置模组版本和日志文件。**

## 分支说明

- `main` 是稳定源码主分支，由 `dev-newFeature` 的稳定状态整理而来，用于维护当前稳定源码、项目介绍和发布说明。
- `dev-newFeature` 是当前主要维护 / 开发基线，基于 Minecraft `1.20.6`，用于记录开发过程和小版本更新日志。
- `mc1.xx.x / mc26.x.x` 分别维护对应 Minecraft 版本代码；其中 `mc1.20.6` 是已存在的 Minecraft `1.20.6` 版本支持分支，会继续保留。
